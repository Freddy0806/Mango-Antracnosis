...
CONFIG = _cleanup(
    {
        "Compilers": {
            "c": {
                ...
                "linker args": r"-L/data/data/com.termux/files/usr/lib, -Wl,-rpath=/data/data/com.termux/files/usr/lib, -Wl,--enable-new-dtags, -Wl,--as-needed, -Wl,-z,relro,-z,now, -Wl,--as-needed,-lpython3.12, -lm",
            },
            "cython": {
                "name": "cython",
                "linker": r"cython",
